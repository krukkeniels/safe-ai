...
# Source: docs/ai-coding-agent-requirements.md
...
# Maps to scenarios in docs/ai-coding-agent-requirements.md
...
See [AI Coding Agent Security Requirements -- Enterprise Scenarios](docs/ai-coding-agent-requirements.md#enterprise-scenarios) for detailed configuration guidance.

---

## AI Coding Agent Security Requirements Assessment

The following assessment maps your environment against the [12 requirements](docs/ai-coding-agent-requirements.md) for enterprise AI coding agent deployment. Requirements R1-R7 are **mandatory**. R8-R12 are **recommended** and become mandatory at higher risk levels.
...
*Source: [AI Coding Agent Security Requirements](docs/ai-coding-agent-requirements.md) | [Enterprise Risk Mapping](docs/enterprise-risk-mapping.md)*
REPORT_EOF
